...
typedef struct effect_vlad_sparkler_0_state
{
    int32_t width;
    int32_t height;
    uint8_t* intensity;
} effect_vlad_sparkler_0_state_t;


void effect_vlad_sparkler_0_destroy(void* void_state);
void effect_vlad_sparkler_0_process(void* void_state, array_t* target_array, int64_t total_time_ns, int64_t frame_time_ns);


rgba_t effect_vlad_sparkler_0_palette[256];


effect_t* effect_vlad_sparkler_0_create(int32_t width, int32_t height)
{
    effect_t* effect = effect_alloc();
    effect_vlad_sparkler_0_state_t* state = (effect_vlad_sparkler_0_state_t*)malloc(sizeof (effect_vlad_sparkler_0_state_t));
    
    effect->void_state = state;
    effect->process = &effect_vlad_sparkler_0_process;
    effect->destroy = &effect_vlad_sparkler_0_destroy;
...
void effect_vlad_sparkler_0_process(void* void_state, array_t* target_array, int64_t total_time_ns, int64_t frame_time_ns)
{
    ...
    for(int x = 0; x < width; x++) 
    {
        ...
        {
            data[y * width + x] = effect_vlad_sparkler_0_palette[intensity[y * intensity_width + x + 1]];
        }
    }
}
