...
void effect_vlad_sinewave_0_process(void* void_state, array_t* target_array, int64_t total_time_ns, int64_t frame_time_ns);
...
effect_t* effect_vlad_sinewave_0_create(void)
{
