...
typedef uint8_t scroll_glyph_t[SCROLL_CHAR_HEIGHT];
...
void init_scroll(scroll_state_t* state)
{
...
void process_scroll(scroll_state_t* state, float time, rgba_t target_array[ARRAY_HEIGHT][ARRAY_STRIDE])
{
    bool stable;
